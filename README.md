...
Secure User access. At the time a user is attempting to sign in the token will be use to verify that the user access information match the cookie created at the time the user created the log in info.

- [ ] What steps can you take in your web apps to keep your data secure?

Filter user inputs, set up authentication system, create secure passwords, protect data

- [ ] Describe how web servers work.

is a program that allowed communication between computers through the net. This is actually the internet.
